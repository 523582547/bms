<template>
  <div class="global-else-wrap">
    <el-tabs
      ...
      @edit="handleTabsEdit"
    >
      <el-tab-pane label="入库管理" name="1"></el-tab-pane>
      <el-tab-pane label="创建入库单" name="2" closable></el-tab-pane>
    </el-tabs>
    <el-main class="else-page-wrap">
      <div class="global-wrapper global-bgfff">
        <p class="title">入库单基本信息</p>
        <el-row>
          <el-col :span="20">
        ...
        <div style="margin-bottom:10px;">
          <el-button type="primary" icon="el-icon-plus" size="mini">手动添加</el-button>
